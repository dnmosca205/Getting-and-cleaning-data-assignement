...
Variables and Data (result data set name "cleaned_data.txt" )
------------------------------------------------------------
...
Please refer to the comments on the code "run_analysis.R" for 
details about the transformations of the raw data .